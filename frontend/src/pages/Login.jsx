      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-10 py-16 bg-white">
        <div className="max-w-md w-full">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Sign in to continue to MeetUp</p>
          </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="max-w-lg text-white">
            ...
            <p className="text-lg text-primary-100 mb-8">
              Join millions of professionals who trust MeetUp for their daily meetings and collaborations.
            </p>
